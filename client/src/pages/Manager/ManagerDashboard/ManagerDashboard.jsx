  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-6">
      ...
      <div className="flex items-start justify-between gap-3 mb-5">
        <div>
          <h2 className="text-lg font-bold text-slate-900">Manager • Panel</h2>
          <p className="text-sm text-slate-500 mt-1">Statistika + raportet e departamentit.</p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-5">
        ...
        <StatCard title="Reviewed" value={reviewedReports} sub="Të verifikuara" tone="emerald" />
      ...
      <div className="rounded-3xl border border-slate-200 bg-white shadow-sm p-4 mb-6">
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="text-[12px] text-slate-500">{loading ? "Loading…" : `Max/ditë: ${max7}`}</div>
        </div>
            ...
            return (
              <div key={d.key} className="flex flex-col items-center gap-2">
                ...
                <div className="w-full h-[76px] flex items-end rounded-2xl bg-slate-50 border border-slate-200 px-1">
                  <div className="w-full rounded-2xl bg-blue-600" style={{ height: h }} title={`${d.key}: ${d.count}`} />
                </div>
      ...
      <div className="flex items-center justify-between mb-3">
        <h3 className="text-sm font-semibold text-slate-900">Raportet e fundit</h3>
