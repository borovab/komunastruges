...
export default function ManagerReports() {
  ...
  const createReport = async (e) => {
    ...
    if (!cTimeReturn) return setErr("Zgjidh orën e kthimit.");
  ...
  return (
    <div className="max-w-6xl mx-auto px-3 sm:px-4 py-4 sm:py-6">
            ...
            >
              ...
              <div className="p-4 sm:p-5 space-y-3 sm:space-y-4 overflow-auto flex-1">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 sm:gap-3">
                  ...
                  <div>
                    <label className="block text-[11px] sm:text-xs font-medium text-slate-700 mb-2">Ora e kthimit</label>
                    <input
                      type="time"
                      value={cTimeReturn}
      ...
      {/* Details Modal (keeps previous behavior; if don, apply same dvh+flex pattern) */}
      {open ? (
        <div className="fixed inset-0 z-[999]">
          ...
          >
            <div
              className="w-full sm:max-w-3xl rounded-t-2xl sm:rounded-3xl border border-slate-200 bg-white shadow-xl overflow-hidden max-h-[85dvh] sm:max-h-none flex flex-col"
            >
              <div className="px-4 sm:px-5 py-3 sm:py-4 border-b border-slate-200 bg-slate-50 flex items-center justify-between gap-3">
                <div className="min-w-0">
